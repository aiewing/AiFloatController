//
//  AIFloatNormal3Controller.swift
...
class AiFloatNormal3Controller: AiFloatController {
    ...
    func loadUI() {
        initFloatController(pullType: .BecomeLarge, headerView: headerView, pullLargeView: nil, floatView: floatView, overlyingHeight: 20, scrollViews: [tableView, tableView2], bottomViews: [nil, nil])
